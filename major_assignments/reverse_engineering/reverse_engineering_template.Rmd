...
allegations <- read_csv("data/allegations_202007271729.csv")
allegations <- read_csv("data/CCRB-Complaint-Data_202007271729.csv")
...
* **Analysis summary**: We used code to filter out the specific data woven throughout this sentence("substantiated allegations", "10 are white", "rank of deputy inspector"). This allowed us to narrow down our data and determine how the data was organized for analysis in this article. This narrowed our code to reutrning 69 rows of information. 
