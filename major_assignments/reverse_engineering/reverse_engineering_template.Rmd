...
* **Analysis summary**: We used code to filter out the specific data woven throughout this sentence("substantiated allegations", "10 are white", "rank of deputy inspector"), which allowed us to narrow down and determine how the data was organized for analysis in this article. We initially narrowed our code by filtering by ethnicity which returned 69 rows of information. We then determined that we needed to further narrow the data by 'rank_now' and 'board_disposition', which enabled us to confirm the finding and successfully reverse engineer our first section of this story.

```{r}
allegations %>%
  filter(mos_ethnicity == "White" ) %>%
  filter(rank_now == "Deputy Inspector" | rank_now == "Inspector" | rank_now == "Deputy Chief" | rank_now == "Assistant Chief" | rank_now == "Bureau Chief" | rank_now == "Police Commissioner" | rank_now == "Chiefs and other ranks" ) %>%
  filter(board_disposition == "Substantiated (Command Lvl Instructions)" |  board_disposition == "Substantiated (Charges)" | board_disposition == "Substantiated (Command Discipline A)" | board_disposition == "Substantiated (Formalized Training)" | board_disposition == "Substantiated (Command Discipline B)" | board_disposition == "Substantiated (Instructions)" | board_disposition == "Substantiated (Command Discipline)" | board_disposition == "Substantiated (Command Discipline)") %>%
...
filter(board_disposition == "Substantiated (Command Lvl Instructions)" |
...
board_disposition == "Substantiated (No Recommendations)" |
