...
**Answer**A problem that prevents proper grouping is how many different variations of city names there are. These include differences mistakes in spelling, capitalization, abbreviations and more. 
...
**Answer** The package merged some of the repeated cities together within the data by changing some capitalization errors. It also caught some abbreviations and merged them with the full versions of their city name. 
...
**Answer** THree changes the refinr function made include changing 'ABELL'to Abell, changing 'ABERDEEN' to 'Aberdeen'and changing 'annapolis' to 'Annapolis'. These are all examples that show howo the refinr function cleans data through changing capitalization. 
...
**Answer** No, the changes it made do not vary substantially from the previous use of key_collision_merge. 
