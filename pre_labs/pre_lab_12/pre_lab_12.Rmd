...
**Answer** There is a county that is titled N/A.
...
**Answer** This produces vacinnations by date for the N/A county. 
...
**Task** Run the following code and describe the data frame it produces. Is there a pattern for the most recent 7-10 days?
**Answer** This data frame shows a row called county, all labeled Prince George's County with rank and the amount of fully vaccinated people. There is a column for date but it does not have anything in it. There is no pattern for the most recent 7-10 days because there is no dates coming up on the ranked column. 
...
**Answer** This chart shows manyt small bars that get smaller over time. 
...
**Answer** The resulting trend shows slightly increasing, color coded lines by county. These represent cases increasing over time. 
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** This chart shows more of a complex version of the same chart above. This shows the increase in cases with the bottom county increasing and then decreasing. 
...
**Answer** 3233 rows in the counties data frame. 
...
**Answer** This map shows the amount of cases on a Maryland lap, separated by county. 
