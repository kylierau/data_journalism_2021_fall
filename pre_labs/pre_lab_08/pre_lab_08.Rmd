...
```{r echo=FALSE}
census_api_key("97677b7fa54c8bb69e6ed34e1b9841350e55ff82", install=TRUE)
```
...
**Answer** Nevada had the largest percentage growth which was 35.15%. 
...
**Answer** Howard County is the county with the highest median household income. 
...
**Answer** No, the difference between Calvert and Montgomery is not significant. 

Is the difference between Howard and everyone else significant?
**Answer** Yes, the difference between Howard and everyone else is significant.
...
**Answer** Somerset County and Caroline County saw their median incomes fall from 2010-2019. Yes the change is outside the margin of error for both. 
```{r}
md10 %>%
...
**Answer** none of the 20 zip codes with the largest amounts have estimated median household incomes less than 50,000 dollars. 
