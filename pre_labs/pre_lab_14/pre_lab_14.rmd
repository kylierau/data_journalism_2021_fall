...
**Answer** This outputs a data frame with tweets posted by politicians that had any covid or coronavirus mentions. 
...
**Answer** This unique function creates differences for the capitalization of words instead of combining them. 
...
**Answer** This function outputs a table of unique words. This changes the text to lowercase and removes all punctuation. 
...
**Answer** This graphic shows a bar chart with the count of these unique words. It is very boring and not visually appealing. 
...
**Answer** This code is not more interesting than before. 
...
**Answer** This code returns a list of unique words with the amount of times they showed up as well as the percentage that they showed up compared ot the others. 
...
**Task** Run the following code and describe the results.
**Answer** This codereturns a data frame that has the top 10 two-word phrases for 2020. 
...
**Task** Run the following code and describe the results.
**Answer** This code returns a data frame with the top 10 two-word phrases for 2021, but we need a filter for party. 
...
**Task** Run the following code and describe the results.
**Answer** This code returns a data frame that has hte top 10 two-word phrases in 2020 organized by political party. 
...
**Task** Run the following code and describe the results.
**Answer** This code returns a data frame with the top 10 two-word phrases in 2020 as well as in 2021 for Republicans party members. 
...
**Answer** This code loads the bing lexicon and produces a data frame that has the word, the type of sentiment and the number of times it was tweeted. 
