...
**Answer** Yes, they have the same column structure. 
...
**Answer** There are 9582 rows in the Maryland PPP data. 
...
**Answer** The error message says, 'can't join on `x$zip` x `y$zip` because of incompatible types. ℹ `x$zip` is of type <character>>. ℹ `y$zip` is of type <double>>. I was unsure what this meant but after conducting some research I think that it means that the columns are not able to combine because the column classes do not match. One is in character type and one is a number type. 
```{r}
...
**Answer** Not every row has demographic data, some say unknown for certain demographic columns. 
...
**Answer** There were 44032 PPP loans that went to ZCTAs with more than 50 percent non-Hispanic Black population. The average amount is 53836.46 and the median amount is 20000. . 
...
**Answer**
There were 113937 loans that went to ZCTAs with more than 50 percent non-Hispanic white population. The average amount was	88140.24 and the median amount was	20833. 
```{r}
...
**Answer**In Rural areas there were	148	loans. The average amount of these wass 44328.87 and the median amount was 19621. In Urban areas, there were 43884 loans. The average amount was	53868.53 and the median amount was 20000.	
...
**Answer** In rural areas, there	were 18337 loans that went to ZCTAs with more than 50 percent non-Hispanic white population with an average of 73694.14 dollars and a median of 20833	dollars. In urban areas there were 95600 loans with an average of 90911.14 dollars and a median of 20833 dollars. 
