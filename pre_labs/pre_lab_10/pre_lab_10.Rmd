...
**Answer** https://app.datawrapper.de/chart/KMeji/publish
...
**Answer** The code below makes a new dataframe called md_counties out of the maryland_ppp data. The data is grouped by project_county_name. 
...
**Answer** This code filters the above data (grouped by project_county_name) and filters out the lower numbers that seem extraneous.
...
**Answer** The new Fips_code column cleaned the data to only have 5-digit FIPS codes. 
...
**Answer** The md_counties_with_fips data frame has all of the data from both the counties and the fips data frames. This combined these two data sets. 
...
**Answer** The map went from a grey visualization of the entire country, to a multicolored visualization of Maryland. 
...
**Answer** tHis map is much more visually appealing. All of the titles are in place, the colors are clear and the labels are easy to navigate. 
...
**Answer** https://app.datawrapper.de/map/qnlrJ/publish
