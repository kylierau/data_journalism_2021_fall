...
**Answer** Multiple different files called hospitals with different extensions.
...
**Answer** This loaded a hospitals data frame with 33 different columns of data. These colums include hospital names, addresses, type, status, population and more. There is also longitude and latitude data. 
...
**Answer** The output is a data frame with information about hospitals in Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This output shows Maryland hospitals grouped by type and summarizes the amount of general acute care hospitals. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This output changes the previous Maryland hospital data frame by filtering it by general acute care hospitals. 
...
Many of these hospitals are in Baltimore, but others are in other parts of Maryland including Silver Spring and Frederick.

We can simply plot them on a longitude-latitude grid using ggplot.

### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output is a scatter plot with longitude and latitude ponints as the x and y axes. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code installed the tigris library. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output of this code is a data frame with information by all U.S. counties. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This output returns all Maryland counties. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This output shows a map of Maryland with longitutde and latitude on the x and y axes. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This returns a map of Maryland with points on it. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This output color codes the map so it is more simple to read. As well as organizes the data by hospital beds. 
...
**Answer** The output simply tells me to install my API key with 'install = TRUE' in future sessions. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output of this code is a data frame with hospital data filtered by Maryland and by General Acute Care hospitals. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This returns two columns, county and total_beds in maryland counties. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output is three columns with county name, variable = population and estimate. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This output returns a data frame called md_county_population by population of B01001_001. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This ouput shows the maryland county population data and the maryland beds by county data. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This output returns a data frame md_county_population that renames county to name, removes any white space that would prevent a proper join in the data, and then renames the column that contains population information from estimate to population. It basically cleans the data frames. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This output returns a data frame that combines the county population with beds by county to show md beds per 100k people. 

```{r}
md_beds_per_100k <- md_county_population %>%
  left_join(md_beds_by_county,by=c("county"))
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This output returns a data frame that combines the beds per 100k with the beds by county and converts Queen Anne's County and Carlolina County to 0 instead of NA. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This returns a data frame with all of the same information as above but with a new column with the number of beds per 100,000 for each county, sorting them from highest to lowest. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code returns a map of the state of Maryland that has the md_beds_per_100k data by longitutde and latitude. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is a new theme of the same map as above that is more asthetically pleasing. The range on the side is 200-600 instead of 0-600. 
...
**Answer** This is again a more asthetically pleasing map that has a the data with percentages instead of the scale from 200-600. 
